...
// 위치: 서울 금천구·경기 광명시 일대 (좌표 실제, 상호는 데모용 가상)
export const DEMO_STORES = [
  { id: 1, name: "행복김밥 독산점", addr: "두산로 70 앞 (지정 배출 지점)", lat: 37.4693, lng: 126.8971 },
  { id: 2, name: "시흥대로 마트", addr: "시흥대로 364 앞", lat: 37.4661, lng: 126.8981 },
  { id: 3, name: "하안 분식", addr: "광명 하안로 298 앞", lat: 37.4589, lng: 126.8755 },
  { id: 4, name: "두산로 카페", addr: "두산로9길 5 앞", lat: 37.4705, lng: 126.8925 },
  { id: 5, name: "골목 슈퍼", addr: "시흥대로122길 17 앞", lat: 37.4695, lng: 126.8992 },
];
...
export const MAX_CLAIM_MINUTES = 30; // 이보다 멀면 선점 불가 (원거리 욕심 선점 방지)
